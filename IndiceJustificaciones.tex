...
\includepdf[pages=-]{Proyectos/Investigacion_Proyectos_Characterization_Of_The_Higgs_Boson_And_Searches.pdf}
...
\subsection{Certificado de proyectos: DESARROLLO DE UN SISTEMA DE ADQUISICIÓN DE DATOS INTELIGENTE (DAQ) PARA LA CARACTERIZACIÓN, CORRECCIÓN Y OBTENCIÓN DE TRAZAS EN DETECTORES DE MUONES de la Universidad de Cantabria}
\includepdf[pages=-]{Transferencia/Transferencia_Articulo83_Proyecto_Muon_Systems.pdf}

\subsection{Certificado de proyectos: Evolución poblacional de municipios en riesgo de despoblamiento mediante gemelos digitales}
\includepdf[pages=-]{Transferencia/Transferencia_Proyecto_Evolucion_Poblacional.pdf}
...
\includepdf[pages=-]{Docencia/Docencia_TFG_Mejora_de_la_discriminacion.pdf}
...
\includepdf[pages=-]{Docencia/Docencia_TFG_Software_de_robot_para_el_ensamblado.pdf}
...
\includepdf[pages=-]{Docencia/Docencia_TFM_Estudio_de_tecnicas_de_computacion.pdf}
...
\includepdf[pages=-]{Docencia/Docencia_TFM_Tecnicas_de_aprendizaje_automatico_profundo.pdf}
...
\includepdf[pages=-]{Docencia/Docencia_TFM_Discriminacion_de_eventos_de_produccion.pdf}
...
\includepdf[pages=-]{Docencia/Docencia_TFG_Reconstruccion_del_Momento_Transverso_de_un.pdf}

\subsubsection{TFM: Estudios del fill factor y software de robot para el endcap timing layer introducido en CMS}
\includepdf[pages=-]{Docencia/Docencia_TFM_Estudios_Fill_Factor.pdf}
