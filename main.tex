...
\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_The_CMS_Experiment_At_The_CERN_LHC.pdf}
...
\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_For_New_Physics_With_Same_Sign_Isolated_Dolepton_Events_With_Jets_And_Missing.pdf}
...
\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Jet_Energy_Resolution_In_The_CMS_Experiment_In_PP_Collisions.pdf}
\subsubsection{The CMS Trigger System}
\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_The_CMS_Trigger_System.pdf}
...
\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Machine_Learning_Methods_For_The_Prediction.pdf}
